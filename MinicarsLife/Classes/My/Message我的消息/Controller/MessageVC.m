...
@property (nonatomic,strong) NoticeVC * vc1;
@property (nonatomic,strong) NoticeVC * vc2;
...
- (void)setupChildViewControll{
    self.vc1 = [[NoticeVC alloc]init];
    self.vc2 = [[NoticeVC alloc]init];
    self.vc3 = [[NoticeVC alloc]init];
    
    self.vc2.typeList = @[@"2",@"3",@"4"];
    self.vc3.typeList = @[@"1"];
