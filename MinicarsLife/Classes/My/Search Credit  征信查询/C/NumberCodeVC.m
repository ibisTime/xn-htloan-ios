...
//    http1.showView = weakSelf.view;
    ...
    [http1 postWithSuccess:^(id responseObject) {
        ...
        if ([dic[@"data"][@"resultMsg"] isEqualToString:@"一致"]) {
            [USERDEFAULTS setObject:textFid1.text forKey:IDNO];
            [USERDEFAULTS setObject:textFid2.text forKey:NAME];
            
            [USERDEFAULTS synchronize];
            [USERXX user].idNo = textFid1.text;
            [TLAlert alertWithInfo:dic[@"msg"]];
