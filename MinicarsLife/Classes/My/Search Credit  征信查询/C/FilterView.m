...
- (void)initSubviews {
    ...
    //背景
    self.pickerView = [[UIView alloc] initWithFrame:CGRectMake(0, SCREEN_HEIGHT, SCREEN_WIDTH, 250)];
...
//    }];
    ...
    UIButton *confirmBtn = [UIButton buttonWithTitle:@"确定"
                                          titleColor:[UIColor colorWithHexString:@"108ee9"] backgroundColor:kClearColor titleFont:15.0];
...
- (void)setTagNames:(NSMutableArray<BaoModel *> *)tagNames
{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        if (_selectBlock2) {
            ...
            if (self.autoSelectOne) {
                ...
                _selectBlock2( 0,self.tagNames[0].areaName);
...
- (void)confirm {
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        if (_selectBlock2) {
                ...
                _selectBlock2( _selectIndex,self.tagNames[_selectIndex].areaName);
...
- (nullable NSString *)pickerView:(UIPickerView *)pickerView titleForRow:(NSInteger)row forComponent:(NSInteger)component {
    ...
    return  self.tagNames[row].areaName;
}
