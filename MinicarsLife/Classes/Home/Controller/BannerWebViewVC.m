...
//  MinicarsLife
//
//  Created by shaojianfei on 2018/12/22.
...
@interface BannerWebViewVC ()<WKNavigationDelegate>
...
- (void)loadWebWithString:(NSString *)string {
    ...
    NSString *html = [NSString stringWithFormat:@"<head><style>img{width:%lfpx !important;height:auto;margin: 0px auto;} p{word-wrap:break-word;overflow:hidden;}</style></head>%@",SCREEN_WIDTH - 16, string];
