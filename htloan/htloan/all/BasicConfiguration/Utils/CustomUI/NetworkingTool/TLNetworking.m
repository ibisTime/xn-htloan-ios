...
//        }
        NSDictionary *userInfo = [NSDictionary dictionaryWithObject:@"url 不存在啊"                                                                      forKey:NSLocalizedDescriptionKey];
        NSError *aError = [NSError errorWithDomain:@"myteam.htloan" code:-1000 userInfo:userInfo];
        failure(aError);
        return nil;
    }
