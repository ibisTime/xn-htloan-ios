...
// 主色
#define kAppCustomMainColor [UIColor colorWithHexString:@"#3184fd"]
//滚动条点未被选中时的颜色
#define kScroImageColor [UIColor colorWithHexString:@"#bec1c7"]
...
#define kviewHeight  kScreenHeight - kNavigationBarHeight-kTabBarHeight
